...
<head>
    ...
    <title>mSpark Admin Products</title>
    <!-- Bootstrap Core CSS -->
...
/*	$size = 10;
	...
	echo '</ul></li></nav>';
*/	
	$sql_display = "SELECT id,details, product_name ,rent, deposit, platform, category, product_quantity, img_one,  DATE_FORMAT(product_release_date, '%d/%m/%Y') AS date FROM products ; "; /*LIMIT ".$start.", ".$size." */
	...
	if ($result->num_rows > 0) {
		...
		echo "</td><td>";
			$MyPhoto = $row['img_one'];
			echo "<img id='".$idd."' src = '../uploads/products/".$MyPhoto."' data-toggle='modal' data-target='#myModal' height='100'/>";
?>
		...
		<form action='update.php' method='POST'>
			...
			<input type = 'submit' class='btn' name= 'change_product' value='Edit'>
		</form>

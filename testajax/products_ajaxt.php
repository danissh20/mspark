...
?>
	...
	<input type="hidden" id="<?php echo $row['rent']; ?>_name" value="<?php echo $row['product_name']; ?>">
    <input type="hidden" id="<?php echo $row['rent']; ?>_price" value="$<?php echo $row['rent']; ?>">
									...
									<div class="block2-overlay trans-0-4">
										...
										<div class="block2-btn-addcart w-size1 trans-0-4">
											<!-- Button -->
											<button class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" value="Add to CART" 
											onclick="cart(<?php echo $row['id'] ?>)">
												Add to Cart
											</button>
										</div>
									</div>

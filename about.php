...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/heading-pages-062.jpg);">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 p-b-30">
					...
					<p class="p-b-28">
						Playing games on a budget was never as easy as it is today with MSPARK. Now there is no need to buy console CD and empty your product
					</p>
